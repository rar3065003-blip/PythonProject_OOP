...
def test_lawngrass_wrong_add(smartphone_1, lawngrass_1):
    with pytest.raises(TypeError):
        result = smartphone_1 + lawngrass_1

def test_demo_work_print(lawngrass_1):
    assert str(lawngrass_1) == ('Газонная трава, 500.0 руб. Остаток: 20 шт. Страна: Россия, Срок прорастания: '
 '7 дней, Цвет: Зеленый')